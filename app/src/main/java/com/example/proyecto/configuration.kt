...
//        val fileInputStream = activity?.openFileInput("myfile.txt")
...
//        var intent = Intent(this.activity, FloatingWindow :: class.java)
...
//            Settings.canDrawOverlays(activity?.baseContext)
//        }
//        else return true
//    }
//
